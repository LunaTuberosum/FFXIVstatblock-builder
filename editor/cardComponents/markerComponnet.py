...
class MarkerComponent(Component):
    ...
    def __get_tileset(self, image: str) -> None:
        ...
        tileset[124] = get_tile((-25, 0))
        tileset[125] = get_tile((-50, 0))
        tileset[241] = get_tile((-75, 0))
        tileset[28] = get_tile((-100, 0))
        tileset[112] = get_tile((-125, 0))
        tileset[92] = get_tile((-150, 0))
        tileset[221] = get_tile((-175, 0))
        
        tileset[17] = get_tile((0, -25))
        tileset[75] = get_tile((-25, -25))
        tileset[255] = get_tile((-50, -25))
        tileset[245] = get_tile((-75, -25))
        tileset[127] = get_tile((-100, -25))
        tileset[253] = get_tile((-125, -25))
        tileset[116] = get_tile((-150, -25))
        tileset[119] = get_tile((-175, -25))
        
        tileset[1] = get_tile((0, -50))
        tileset[31] = get_tile((-25, -50))
        tileset[215] = get_tile((-50, -50))
        tileset[199] = get_tile((-75, -50))
        tileset[223] = get_tile((-100, -50))
        tileset[247] = get_tile((-125, -50))
        tileset[71] = get_tile((-150, -50))
        tileset[20] = get_tile((-175, -50))
        tileset[80] = get_tile((-200, -50))
        
        tileset[0] = get_tile((0, -75))
        tileset[4] = get_tile((-25, -75))
        tileset[68] = get_tile((-50, -75))
        tileset[64] = get_tile((-75, -75))
        tileset[7] = get_tile((-100, -75))
        tileset[193] = get_tile((-125, -75))
        tileset[197] = get_tile((-150, -75))
        tileset[5] = get_tile((-175, -75))
        tileset[65] = get_tile((-200, -75))
    ...
    def __render_tiles(self) -> None:
        ...
        marker_tileset: dict[int, pygame.Surface] = self.__get_tileset('.\\assets\\markerIcons\\SquareMarkerTileset.png')
        origin_tileset: dict[int, pygame.Surface] = self.__get_tileset('.\\assets\\markerIcons\\SquareOriginTileset.png')
